                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <button
                            ...
                            onClick={() => props.setChangeNameDialog(true)}
                          >
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            ...
                            onClick={() => props.setAddSomeoneDialog(true)}
                          >
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            ...
                            onClick={() => props.setListOfUsersDialog(true)}
                          >
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            ...
                            onClick={() => props.setLeaveChannelDialog(true)}
                          >
